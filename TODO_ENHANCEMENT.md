...
- [x] **5.1 カーボンフットプリントの可視化**
    - [x] 輸送モード（空路 vs 海路）に応じたCO2排出量の算出ロジック。
    - [x] 総排出量に対する炭素税や環境規制によるペナルティの実装。
- [x] **5.2 グリーン投資 (Green Transformation)**
    - [x] 電気貨物船、再生可能エネルギー工場へのアップグレード。
    - [x] グリーン投資による長期的な税負担軽減とブランド価値（需要増）の反映。
- [x] **5.3 ESG経営スコア**
    - [x] 利益、欠品率、環境負荷の3軸で評価される最終成績評価システム。
